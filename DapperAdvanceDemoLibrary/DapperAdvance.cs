...
{
    public class DapperAdvance
    {
        public static List<FullPersonModel> MapMultipleObjects()
        {
            ...
            using (IDbConnection cnn = new SqlConnection(Tools.GetConnectionString()))
            {
                ...
                fullPersonModel = cnn.Query<FullPersonModel, PhoneModel, FullPersonModel>(sql,
                    (person, phone) => { person.CellPhone = phone; return person; }).ToList();
